...
export function buildSystemPromptAppend(config: AgentConfig): string {
  ...
  parts.push(`\nWhen you produce a deliverable (spec section, investigation report, etc.), write it to the appropriate ticket field using meldui_write_section. The user controls when to advance to the next step.`);
