...
export function DiffLine({ line, onClickLine }: DiffLineProps) {
  ...
  return (
    <div className={`group flex items-stretch text-xs font-mono ${bgClass} hover:brightness-95 dark:hover:brightness-110`}>
      {/* Line numbers */}
      ...
      {/* Prefix */}
      <div className={`w-5 shrink-0 text-center select-none py-0.5 ${textClass}`}>
        {prefix}
      </div>
