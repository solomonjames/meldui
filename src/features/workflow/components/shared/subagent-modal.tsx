            ...
            <div>
              ...
              <div className="grid grid-cols-3 gap-3">
                <div className="rounded-lg bg-zinc-50 dark:bg-zinc-800 p-2.5 text-center">
                  <p className="text-lg font-semibold">{activity.usage.total_tokens.toLocaleString()}</p>
                ...
                <div className="rounded-lg bg-zinc-50 dark:bg-zinc-800 p-2.5 text-center">
                  <p className="text-lg font-semibold">{(activity.usage.duration_ms / 1000).toFixed(1)}s</p>
